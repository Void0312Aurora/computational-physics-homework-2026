...
\begin{figure}[H]
\centering
\includegraphics[width=0.96\linewidth,height=0.84\textheight,keepaspectratio,alt={Problem 3 roundoff comparison in half precision}]{../../../result/problem3_roundoff.png}
