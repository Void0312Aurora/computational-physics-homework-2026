...
\reportgroup{I. 一维 Ising 模型的 Metropolis 模拟}
...
\reportgroup{II. 一维 Ising 模型的 demon 算法}
...
\reportgroup{III. 二维正方格 Ising 模型}
...
\reportgroup{IV. 二维 Ising 模型磁化与有限尺寸标度}
