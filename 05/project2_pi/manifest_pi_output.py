...
DEFAULT_TARGET = Path("result/project2_pi_100000000_digits.txt")
DEFAULT_OUTPUT = Path("result/project2_pi_100000000_digits.txt.manifest.json")
DEFAULT_YCRUNCHER_CSV = Path("result/project2_ycruncher_benchmark.csv")
DEFAULT_YCRUNCHER_VALIDATION_DIR = Path("result/ycruncher/validation")
WINDOW_BYTES = 80
