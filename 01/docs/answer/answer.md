...
**Problem 1：LCRS 星系样本的清洗与极值统计**

题目给出 `lcrs.txt`。文件前部包含注释行，数据区的每条有效记录有四列，分别表示 recession velocity、球坐标角 `theta`、球坐标角 `phi` 以及红光波段 absolute magnitude。

## Problem 1(a)：数据清洗与速度极值

相关脚本：

- [本地 scripts/problem1.py](../../scripts/problem1.py)
- [GitHub scripts/problem1.py](https://github.com/Void0312Aurora/computational-physics-homework-2026/blob/main/01/scripts/problem1.py)
...
- [GitHub scripts/problem2.py](https://github.com/Void0312Aurora/computational-physics-homework-2026/blob/main/01/scripts/problem2.py)
