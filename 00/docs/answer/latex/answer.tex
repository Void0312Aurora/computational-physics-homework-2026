...
\definecolor{headingcolor}{HTML}{1F2933}
\definecolor{mutedtext}{HTML}{4F5B66}
\definecolor{rulecolor}{HTML}{CBD2D9}
\definecolor{linkblue}{HTML}{2563A7}
...
\titleformat{\subsection}
  {\large\sffamily\bfseries\color{headingcolor}}
  {\thesubsection}{0.75em}{}
\titlespacing*{\subsection}{0pt}{1.35\baselineskip}{0.45\baselineskip}
\titleformat{\subsubsection}
  {\normalsize\sffamily\bfseries\color{headingcolor}}
  {\thesubsubsection}{0.65em}{}
\titlespacing*{\subsubsection}{0pt}{1.05\baselineskip}{0.25\baselineskip}

\newcommand{\reportgroup}[1]{%
  \phantomsection\addcontentsline{toc}{section}{#1}%
  {\Large\sffamily\bfseries\color{headingcolor} #1\par}%
...
\newcommand{\scriptpath}[1]{{\footnotesize\sffamily #1}}
\newcommand{\githubscriptsbase}{https://github.com/Void0312Aurora/computational-physics-homework-2026/blob/main/00/scripts}
\newcommand{\scriptlink}[1]{\noindent{\footnotesize\sffamily\color{mutedtext}\textbf{相关脚本}\quad \href{../../../scripts/#1}{\scriptpath{本地 scripts/#1}} \,/\, \href{\githubscriptsbase/#1}{\scriptpath{GitHub scripts/#1}}}\par\vspace{0.35\baselineskip}}
